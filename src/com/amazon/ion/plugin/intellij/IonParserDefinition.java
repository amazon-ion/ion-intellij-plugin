...
import com.amazon.ion.plugin.intellij.parser.IonParser;
...
public class IonParserDefinition implements ParserDefinition {
    ...
    public static final TokenSet COMMENTS = TokenSet.create(IonTypes.COMMENT);

    public static final IFileElementType FILE = new IFileElementType(Language.<IonLanguage>findInstance(IonLanguage.class));
    ...
    public PsiFile createFile(FileViewProvider viewProvider) {
        return new IonFile(viewProvider);
    }
