...
import com.amazon.ion.plugin.intellij.formatting.blocks.IonSExpressionBlock
...
private val ParentContainerTypes = setOf(IonListBlock::class, IonSExpressionBlock::class, IonStructBlock::class)
...
private fun createSpaceBuilder(settings: CodeStyleSettings) =
    SpacingBuilder(settings, IonLanguage.INSTANCE).apply {
        ...
        afterInside(IonTypes.COMMA, IonTypes.LIST).lineBreakInCode()
