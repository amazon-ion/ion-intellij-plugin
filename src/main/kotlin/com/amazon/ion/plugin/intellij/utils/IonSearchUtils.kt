...
import com.amazon.ion.plugin.intellij.psi.IonExpressionOperator
...
object IonSearchUtils {
    ...
    fun findIonExpressionOperators(project: Project): List<IonExpressionOperator> {
        ...
        return ionFiles.flatMap {
            ...
            PsiTreeUtil.getChildrenOfType(ionFile, IonExpressionOperator::class.java).toList()
        }
    }

    fun findIonExpressionOperators(project: Project, name: String): List<IonExpressionOperator> =
