...
public class IonMembersImpl extends ASTWrapperPsiElement implements IonMembers {

  public IonMembersImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IonPair> getPairList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IonPair.class);
  }
