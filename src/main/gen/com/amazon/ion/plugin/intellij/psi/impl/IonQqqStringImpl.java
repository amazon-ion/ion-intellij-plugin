...
public class IonQqqStringImpl extends ASTWrapperPsiElement implements IonQqqString {

  public IonQqqStringImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IonVisitor visitor) {
    visitor.visitQqqString(this);
  }
